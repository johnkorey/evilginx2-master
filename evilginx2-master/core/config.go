...
type SecuritySettings struct {
	BlockDatacenters      bool `mapstructure:"block_datacenters" json:"block_datacenters" yaml:"block_datacenters"`
	BlockBots             bool `mapstructure:"block_bots" json:"block_bots" yaml:"block_bots"`
	BlockHeadlessBrowsers bool `mapstructure:"block_headless" json:"block_headless" yaml:"block_headless"`
}
...
func NewConfig(cfg_dir string, path string) (*Config, error) {
	...
	c.telegramConfig = &TelegramConfig{}
	...
	c.cfg.UnmarshalKey(CFG_SECURITY, &c.securitySettings)
...
func (c *Config) SetTelegramConfig(botToken string, chatID string, enabled bool) {
...
func (c *Config) IsTelegramEnabled() bool {
	return c.telegramConfig.Enabled && c.telegramConfig.BotToken != "" && c.telegramConfig.ChatID != ""
}
...
// Security settings
func (c *Config) GetSecurityBlockDatacenters() bool {
	return c.securitySettings.BlockDatacenters
}

func (c *Config) GetSecurityBlockBots() bool {
	return c.securitySettings.BlockBots
}

func (c *Config) GetSecurityBlockHeadless() bool {
	return c.securitySettings.BlockHeadlessBrowsers
}

func (c *Config) SetSecuritySettings(blockDatacenters, blockBots, blockHeadless bool) {
	c.securitySettings.BlockDatacenters = blockDatacenters
	c.securitySettings.BlockBots = blockBots
	c.securitySettings.BlockHeadlessBrowsers = blockHeadless
	c.cfg.Set(CFG_SECURITY, c.securitySettings)
	c.cfg.WriteConfig()
}

func (c *Config) GetSecuritySettings() *SecuritySettings {
